...
<script type="text/javascript" src="${ctx}/include/js/orgunit/orgUnit.js"></script>
<body class="easyui-layout"> 
		<div id="cc" class="easyui-layout" style="width:100%;height:100%;">
		    <input type="hidden" id="roleType" name="roleType" value="${roleType?if_exists}"/>
		        ...
		        <form id="f_xm" name="f_xm"  method="post">
		        		...
		        		<table width="100%" align="center" cellpadding="2" cellspacing="1" class="table">
							   <tr class="alternate_line2">
							        <td width="20%" class="td_title">部门名称：</td>
							         <td width="30%" class="td_content">
							        	<input id="name" type="text" name="name" class="c_textbox" value="${(obj.deptname)?if_exists}"/>
							        </td>
							        <td width="20%" class="td_title">上级部门：</td>
							        <td width="30%" class="td_content">
							        	<input id="parentname" type="text" name="parentname" disabled="true" class="c_textbox" value="${(obj.parentname)?if_exists}"/>
							  ...
							  <tr class="alternate_line2">
							        ...
							        <td width="30%" class="td_content">
							        	<input class="c_textbox" id="sortno" name="sortno" type="text" value="${(obj.sortno)?if_exists}"/>
							        </td>
						       </tr>
						        ...
						        <tr class="alternate_line2">
							        ...
							        <td width="80%" align="left" class="td_content" colspan='3'>
							        	<input id="remark"  name="remark" type='text' class="c_textbox" data-options="multiline:true" style="height: 50px;" value="${(obj.remark)?if_exists}" />
							        </td>
							  </tr>
				    </table>
