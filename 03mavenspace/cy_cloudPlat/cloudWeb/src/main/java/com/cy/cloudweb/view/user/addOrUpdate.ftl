						     ...
						     <table align="center" border="0" width="100%">
								  <tr>	
								        ...
								        <td width="15%" align="left">
								            <input id="form_account" name="account" type="text" class="easyui-textbox" value="${(obj.account)?if_exists}"/>
								        </td>
								        <td align="right">密码：</td>
								        <td width="15%" align="left">
								        	<input id="form_password" type="password" name="password" class="easyui-textbox" value="${(obj.password)?if_exists}"/>
								        </td>
								        <td align="right">姓名：</td>
								        <td width="15%" align="left">
								        	<input id="form_username" type="text" name="username" class="easyui-textbox" value="${(obj.username)?if_exists}"/>
								        </td>
								        <td align="right">性别：</td>
								        <td width="15%" align="left">
									        <select id="sex" class="easyui-combobox" name="sex" panelHeight="70">
								  ...
								  <tr>	
		  						   ...
		  						   <tr>
								        ...
								        <td colspan="5">
								        	<textarea id="remark" rows="3"  name="remark" class="textarea easyui-validatebox" style="width:100%;overflow:hidden;" value="${(obj.remark)?if_exists}">${(obj.remark)?if_exists}</textarea>
								        </td>
								  </tr>
						    </table>
					    </fieldset>
