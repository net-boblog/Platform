...
<script type="text/javascript" src="${ctx}/include/js/menu/menu.js"></script>
		...
		<div id="cc" class="easyui-layout" style="width:100%;height:100%;">   
		    ...
		    <div data-options="region:'center',title:'菜单信息'" style="padding:1px;">
	    		...
	    		<div data-options="region:'south',border:false" style="text-align:right;padding:5px 0 0;">
					...
					<a class="easyui-linkbutton" data-options="iconCls:'icon-cancel'" href="javascript:void(0) style="width:80px">重置</a>
				</div>
		    </div>
