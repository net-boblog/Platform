...
<script type="text/javascript" src="${ctx}/include/js/role/adminRole.js"></script>
...
<body  class="easyui-layout">
		    ...
		    <div id="treeMenu0" class="easyui-menu" style="width:50px;">
   				<div onclick="addRole()" style="width:100%;">新增</div>
			</div>
			
			<div id="treeMenu1" class="easyui-menu" style="width:50px;">
