...
public class SchedulerAction {
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/scheduler_addOrUpdateSchedulerTask.pt")
	public ModelAndView addOrUpdateSchedulerTask(HttpServletRequest req, HttpServletResponse resp) throws Exception {
		ModelAndView view = new ModelAndView("scheduler/addOrUpdateSchedulerTask.ftl");
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/scheduler_addOrUpdateScheduler.pt")
	public ModelAndView addOrUpdateScheduler(HttpServletRequest req, HttpServletResponse resp) throws Exception {
		ModelAndView view = new ModelAndView("scheduler/addOrUpdateScheduler.ftl");
